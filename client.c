...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/18 12:22:09 by eddos-sa          #+#    #+#             */
/*   Updated: 2023/11/18 15:40:53 by eddos-sa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_bits(unsigned char *argv, int pid)
{
	int	i;
	int	j;
...
void	ft_message(int id)
{
	static char	*message[1] = {
		...
		"Please write : ./client (pid) \"message\"\n"
	};
...
int	main(int argc, char **argv)
{
	...
	if (argc == 3 && ft_isalldigit(argv[1]))
	{
		...
		ft_bits((unsigned char *)argv[2], pid);
		return (1);
	}
	else
		ft_message(0);
